    ...
    function $olderPosts(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var childPageIndex58 = 0; childPageIndex58 < childPageListLen58; childPageIndex58++) {
        ...
        if (opt_data.page.url != childPageData58.url) {
          ...
          ie_open('a', null, null, 'class', 'post-item__link', 'href', childPageData58.url);
          ie_open('small');
          itext('By ');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param65 = function param65() {
        ...
        $templateAlias3({ section: opt_data.site.index.children[0] }, null, opt_ijData);
        $guide(opt_data, null, opt_ijData);
      };
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'guide', content: param65 }, opt_data), null, opt_ijData);
      ie_close('div');
    }
    exports.render = $render;
    if (goog.DEBUG) {
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'topbar-invert topbar-fixed' }, opt_data), null, opt_ijData);
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $logo(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('span', null, null, 'class', 'topbar-logo');
      ie_open('img', null, null, 'src', '/images/logo.png');
      ie_close('img');
      ie_close('span');
      ie_close('a');
      ie_close('div');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $demo(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias2({ divId: 'why', contentHtml: param17 }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
    }
    exports.demo = $demo;
...
(function () {
  ...
  var Demo = function (_Component) {
    babelHelpers.inherits(Demo, _Component);

    function Demo() {
      babelHelpers.classCallCheck(this, Demo);
      return babelHelpers.possibleConstructorReturn(this, (Demo.__proto__ || Object.getPrototypeOf(Demo)).apply(this, arguments));
    }
  ...
  this['metalNamed']['Demo'] = this['metalNamed']['Demo'] || {};
  this['metalNamed']['Demo']['Demo'] = Demo;
  this['metalNamed']['Demo']['templates'] = templates;
  this['metal']['Demo'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param164 = function param164() {
        $templateAlias2(soy.$$assignDefaults({ elementClasses: 'topbar-invert topbar-docs-main' }, opt_data), null, opt_ijData);
        $templateAlias3({ section: opt_data.site.index.children[0] }, null, opt_ijData);
    ...
    function $topics(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'row');
      var topicList192 = opt_data.site.index.children[0].children;
      var topicListLen192 = topicList192.length;
      for (var topicIndex192 = 0; topicIndex192 < topicListLen192; topicIndex192++) {
        var topicData192 = topicList192[topicIndex192];
        if (!topicData192.hidden) {
          ie_open('div', null, null, 'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
          ie_open('a', null, null, 'class', 'topic radial-out', 'href', topicData192.url);
          ie_open('div', null, null, 'class', 'topic-icon');
          ie_void('span', null, null, 'class', 'icon-16-' + topicData192.icon);
          ie_close('div');
          ie_open('h3', null, null, 'class', 'topic-title');
          var dyn15 = topicData192.title;
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param198 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param210 = function param210() {
        ie_open('div');
      ...
      $templateAlias1(soy.$$assignDefaults({ content: param210 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param242 = function param242() {
        ie_open('h6');
        ...
        itext('Core');
        ie_close('h2');
        ie_open('section', null, null, 'class', 'guide-nested');
        ie_open('h4', null, null, 'class', 'guide-step');
      ...
      $templateAlias1(soy.$$assignDefaults({ content: param242 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param218 = function param218() {
        ...
        ie_close('h2');
        ie_open('p');
        ie_open('span', null, null, 'class', 'code-header');
        itext('Open a terminal on your computer and execute');
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: '[sudo] npm install -g gulp', mode: 'bash' }, null, opt_ijData);
        ie_close('article');
        ...
        ie_close('strong');
        itext(' button in our ');
        ie_open('a', null, null, 'href', 'https://github.com/liferay/alloy-editor');
        ...
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: '[sudo] npm install', mode: 'bash' }, null, opt_ijData);
        ie_close('article');
        ie_open('article', null, null, 'id', 'article5');
        ie_open('h2');
        ...
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: 'gulp build', mode: 'bash' }, null, opt_ijData);
        ie_open('p', null, null, 'class', 'guide-note');
  ...
  var docsDevelopHowToBuildItHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopHowToBuildItHtml, _Component);

    function docsDevelopHowToBuildItHtml() {
      babelHelpers.classCallCheck(this, docsDevelopHowToBuildItHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopHowToBuildItHtml.__proto__ || Object.getPrototypeOf(docsDevelopHowToBuildItHtml)).apply(this, arguments));
    }

    return docsDevelopHowToBuildItHtml;
  }(Component);

  Soy.register(docsDevelopHowToBuildItHtml, templates);
  this['metalNamed']['how_to_build_it'] = this['metalNamed']['how_to_build_it'] || {};
  this['metalNamed']['how_to_build_it']['docsDevelopHowToBuildItHtml'] = docsDevelopHowToBuildItHtml;
  this['metalNamed']['how_to_build_it']['templates'] = templates;
  this['metal']['how_to_build_it'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['how_to_build_it'];
  ...
  this['metal']['docsDevelopHowToBuildItHtml'] = docsDevelopHowToBuildItHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsUse.
     * @public
     */

    goog.module('docsUse.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param285 = function param285() {
        ...
        ie_close('p');
        $templateAlias2({ code: '<link href="alloy-editor/assets/alloy-editor-ocean-min.css" rel="stylesheet">\n<script src="alloy-editor/alloy-editor-all-min.js"><\/script>', mode: 'html' }, null, opt_ijData);
        ie_open('p');
        itext('If you downloaded it via Bower:');
        ie_close('p');
        $templateAlias2({ code: '<link href="bower_components/alloyeditor/dist/alloy-editor/assets/alloy-editor-ocean-min.css" rel="stylesheet">\n<script src="bower_components/alloyeditor/dist/alloy-editor/alloy-editor-all-min.js"><\/script>', mode: 'html' }, null, opt_ijData);
        ie_close('article');
        ie_open('article', null, null, 'id', 'article3');
        ie_open('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsUse.render';
    }
  ...
  var docsUse = function (_Component) {
    babelHelpers.inherits(docsUse, _Component);

    function docsUse() {
      babelHelpers.classCallCheck(this, docsUse);
      return babelHelpers.possibleConstructorReturn(this, (docsUse.__proto__ || Object.getPrototypeOf(docsUse)).apply(this, arguments));
    }

    return docsUse;
  }(Component);

  Soy.register(docsUse, templates);
  this['metalNamed']['index'] = this['metalNamed']['index'] || {};
  this['metalNamed']['index']['docsUse'] = docsUse;
  this['metalNamed']['index']['templates'] = templates;
  this['metal']['index'] = templates;
  /* jshint ignore:end */
}).call(this);
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from hot_to_use_it.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsUseHotToUseItHtml.
     * @public
     */

    goog.module('docsUseHotToUseItHtml.incrementaldom');
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param251 = function param251() {
        ie_open('h6');
        itext('The section below assumes that you are using the default UI, which is built using React. The AlloyEditor core is fully separated from the UI and creating another one based on any other framework is very easy.');
        ie_close('h6');
        ie_open('article', null, null, 'id', 'article1');
        ...
        ie_close('h2');
        $templateAlias2({ code: '<link href="alloy-editor/assets/alloy-editor-ocean-min.css" rel="stylesheet"></link>', mode: 'html' }, null, opt_ijData);
        ie_close('article');
        ie_open('article', null, null, 'id', 'article2');
        ie_open('h2');
        ...
        ie_close('span');
        $templateAlias2({ code: '<script src="alloy-editor/alloy-editor-all-min.js"><\/script>', mode: 'html' }, null, opt_ijData);
        ie_open('p');
        ie_open('span');
        ...
        ie_open('pre');
        ie_open('code');
        ie_void('script', null, null, 'src', 'alloy-editor/alloy-editor-no-ckeditor-min.js');
        ie_close('code');
        ie_close('pre');
        ie_open('p');
        ie_open('span');
        ...
        ie_open('pre');
        ie_open('code');
        ie_void('script', null, null, 'src', 'alloy-editor/alloy-editor-no-react-min.js');
        ie_close('code');
        ie_close('pre');
        ie_open('p');
        ie_open('span');
        ...
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: '<script src="alloy-editor/alloy-editor-core-min.js"><\/script>', mode: 'html' }, null, opt_ijData);
        ie_close('section');
        ie_close('article');
        ie_open('article', null, null, 'id', 'article3');
        ie_open('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsUseHotToUseItHtml.render';
    }
  ...
  var docsUseHotToUseItHtml = function (_Component) {
    babelHelpers.inherits(docsUseHotToUseItHtml, _Component);

    function docsUseHotToUseItHtml() {
      babelHelpers.classCallCheck(this, docsUseHotToUseItHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsUseHotToUseItHtml.__proto__ || Object.getPrototypeOf(docsUseHotToUseItHtml)).apply(this, arguments));
    }

    return docsUseHotToUseItHtml;
  }(Component);

  Soy.register(docsUseHotToUseItHtml, templates);
  this['metalNamed']['hot_to_use_it'] = this['metalNamed']['hot_to_use_it'] || {};
  this['metalNamed']['hot_to_use_it']['docsUseHotToUseItHtml'] = docsUseHotToUseItHtml;
  this['metalNamed']['hot_to_use_it']['templates'] = templates;
  this['metal']['hot_to_use_it'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['hot_to_use_it'];
  ...
  this['metal']['docsUseHotToUseItHtml'] = docsUseHotToUseItHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  var docsDevelopCreateCreateButtonsHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopCreateCreateButtonsHtml, _Component);

    function docsDevelopCreateCreateButtonsHtml() {
      babelHelpers.classCallCheck(this, docsDevelopCreateCreateButtonsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopCreateCreateButtonsHtml.__proto__ || Object.getPrototypeOf(docsDevelopCreateCreateButtonsHtml)).apply(this, arguments));
    }

    return docsDevelopCreateCreateButtonsHtml;
  }(Component);

  Soy.register(docsDevelopCreateCreateButtonsHtml, templates);
  this['metalNamed']['create_buttons'] = this['metalNamed']['create_buttons'] || {};
  this['metalNamed']['create_buttons']['docsDevelopCreateCreateButtonsHtml'] = docsDevelopCreateCreateButtonsHtml;
  this['metalNamed']['create_buttons']['templates'] = templates;
  this['metal']['create_buttons'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param328 = function param328() {
        ...
        ie_open('a', null, null, 'href', '/docs/use/how_to_build_it.html');
        ...
        ie_open('a', null, null, 'href', '/docs/use/skins.html');
        ...
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: '<link href="alloy-editor/assets/alloy-editor-zebra-min.css" rel="stylesheet">', mode: 'html' }, null, opt_ijData);
        ie_open('p');
  ...
  var docsDevelopCreateCreateSkinHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopCreateCreateSkinHtml, _Component);

    function docsDevelopCreateCreateSkinHtml() {
      babelHelpers.classCallCheck(this, docsDevelopCreateCreateSkinHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopCreateCreateSkinHtml.__proto__ || Object.getPrototypeOf(docsDevelopCreateCreateSkinHtml)).apply(this, arguments));
    }

    return docsDevelopCreateCreateSkinHtml;
  }(Component);

  Soy.register(docsDevelopCreateCreateSkinHtml, templates);
  this['metalNamed']['create_skin'] = this['metalNamed']['create_skin'] || {};
  this['metalNamed']['create_skin']['docsDevelopCreateCreateSkinHtml'] = docsDevelopCreateCreateSkinHtml;
  this['metalNamed']['create_skin']['templates'] = templates;
  this['metal']['create_skin'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param347 = function param347() {
        ...
        ie_open('a', null, null, 'href', '/docs/develop/create/create_buttons.html');
  ...
  var docsDevelopCreateCreateToolbarsHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopCreateCreateToolbarsHtml, _Component);

    function docsDevelopCreateCreateToolbarsHtml() {
      babelHelpers.classCallCheck(this, docsDevelopCreateCreateToolbarsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopCreateCreateToolbarsHtml.__proto__ || Object.getPrototypeOf(docsDevelopCreateCreateToolbarsHtml)).apply(this, arguments));
    }

    return docsDevelopCreateCreateToolbarsHtml;
  }(Component);

  Soy.register(docsDevelopCreateCreateToolbarsHtml, templates);
  this['metalNamed']['create_toolbars'] = this['metalNamed']['create_toolbars'] || {};
  this['metalNamed']['create_toolbars']['docsDevelopCreateCreateToolbarsHtml'] = docsDevelopCreateCreateToolbarsHtml;
  this['metalNamed']['create_toolbars']['templates'] = templates;
  this['metal']['create_toolbars'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param366 = function param366() {
        ...
        ie_open('p');
        itext('Follow the instructions in our ');
        ie_open('a', null, null, 'href', 'guids/how_to_build_it');
        itext('How to build it');
        ie_close('a');
        itext(' Guide to know how to change and build AlloyEditor.');
        ie_close('p');
        ...
        ie_close('span');
        ie_close('p');
        $templateAlias2({ code: 'gulp --ui jquery', mode: 'bash' }, null, opt_ijData);
        ie_open('p');
  ...
  var docsDevelopCreateCreateUiHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopCreateCreateUiHtml, _Component);

    function docsDevelopCreateCreateUiHtml() {
      babelHelpers.classCallCheck(this, docsDevelopCreateCreateUiHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopCreateCreateUiHtml.__proto__ || Object.getPrototypeOf(docsDevelopCreateCreateUiHtml)).apply(this, arguments));
    }

    return docsDevelopCreateCreateUiHtml;
  }(Component);

  Soy.register(docsDevelopCreateCreateUiHtml, templates);
  this['metalNamed']['create_ui'] = this['metalNamed']['create_ui'] || {};
  this['metalNamed']['create_ui']['docsDevelopCreateCreateUiHtml'] = docsDevelopCreateCreateUiHtml;
  this['metalNamed']['create_ui']['templates'] = templates;
  this['metal']['create_ui'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsDevelopCreate.
     * @public
     */

    goog.module('docsDevelopCreate.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param380 = function param380() {
        ...
        ie_open('i');
        itext('Please, check our ');
        ie_open('a', null, null, 'href', '/docs/develop/create/create_skin.html');
        ...
        ie_open('i');
        itext('Please, check our ');
        ie_open('a', null, null, 'href', '/docs/develop/create/create_toolbars.html');
        ...
        ie_open('i');
        itext('Please, check our ');
        ie_open('a', null, null, 'href', '/docs/develop/create.html');
        itext('Create Toolbars Guide');
        ie_close('a');
        itext('!');
        ie_close('i');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsDevelopCreate.render';
    }
  ...
  var docsDevelopCreate = function (_Component) {
    babelHelpers.inherits(docsDevelopCreate, _Component);

    function docsDevelopCreate() {
      babelHelpers.classCallCheck(this, docsDevelopCreate);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopCreate.__proto__ || Object.getPrototypeOf(docsDevelopCreate)).apply(this, arguments));
    }

    return docsDevelopCreate;
  }(Component);

  Soy.register(docsDevelopCreate, templates);
  this['metalNamed']['index'] = this['metalNamed']['index'] || {};
  this['metalNamed']['index']['docsDevelopCreate'] = docsDevelopCreate;
  this['metalNamed']['index']['templates'] = templates;
  this['metal']['index'] = templates;
  /* jshint ignore:end */
}).call(this);
...
(function () {
  ...
  this['metal']['docsDevelopCreate'] = docsDevelopCreate;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['create_buttons'];
  ...
  this['metal']['docsDevelopCreateCreateButtonsHtml'] = docsDevelopCreateCreateButtonsHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['create_skin'];
  ...
  this['metal']['docsDevelopCreateCreateSkinHtml'] = docsDevelopCreateCreateSkinHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['create_toolbars'];
  ...
  this['metal']['docsDevelopCreateCreateToolbarsHtml'] = docsDevelopCreateCreateToolbarsHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['create_ui'];
  ...
  this['metal']['docsDevelopCreateCreateUiHtml'] = docsDevelopCreateCreateUiHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsUseCkeditorPlugins.
     * @public
     */

    goog.module('docsUseCkeditorPlugins.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param389 = function param389() {
        ...
        ie_open('a', null, null, 'href', 'http://ckeditor.com/addons/plugins/all');
        ...
        ie_open('a', null, null, 'href', 'http://ckeditor.com/addon/font');
        ...
        ie_open('ul');
        ie_open('li');
        ie_open('a', null, null, 'href', 'http://alloyeditor.com/api/classes/CKEDITOR.plugins.ae_buttonbridge.html');
        itext('Button');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', 'http://alloyeditor.com/api/classes/CKEDITOR.plugins.ae_panelmenubuttonbridge.html');
        itext('Panel Menu Button');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', 'http://alloyeditor.com/api/classes/CKEDITOR.plugins.ae_richcombobridge.html');
        itext('RichCombo');
        ie_close('a');
        ie_close('li');
        ie_close('ul');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsUseCkeditorPlugins.render';
    }
  ...
  var docsUseCkeditorPlugins = function (_Component) {
    babelHelpers.inherits(docsUseCkeditorPlugins, _Component);

    function docsUseCkeditorPlugins() {
      babelHelpers.classCallCheck(this, docsUseCkeditorPlugins);
      return babelHelpers.possibleConstructorReturn(this, (docsUseCkeditorPlugins.__proto__ || Object.getPrototypeOf(docsUseCkeditorPlugins)).apply(this, arguments));
    }

    return docsUseCkeditorPlugins;
  }(Component);

  Soy.register(docsUseCkeditorPlugins, templates);
  this['metalNamed']['index'] = this['metalNamed']['index'] || {};
  this['metalNamed']['index']['docsUseCkeditorPlugins'] = docsUseCkeditorPlugins;
  this['metalNamed']['index']['templates'] = templates;
  this['metal']['index'] = templates;
  /* jshint ignore:end */
}).call(this);
...
(function () {
  ...
  this['metal']['docsUseCkeditorPlugins'] = docsUseCkeditorPlugins;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param413 = function param413() {
        ...
        ie_open('a', null, null, 'alt', 'code source of undo plugin', 'href', 'https://github.com/ckeditor/ckeditor-dev/blob/master/plugins/undo/plugin.js#L105-L109');
        itext('It\xB4s code source');
        ie_close('a');
        ...
        ie_open('p');
        itext('Following ');
        ie_open('a', null, null, 'alt', 'toolbar configuration', 'href', 'guides/ckeditor_plugins/ui_button');
  ...
  var docsUseCkeditorPluginsUiButtonHtml = function (_Component) {
    babelHelpers.inherits(docsUseCkeditorPluginsUiButtonHtml, _Component);

    function docsUseCkeditorPluginsUiButtonHtml() {
      babelHelpers.classCallCheck(this, docsUseCkeditorPluginsUiButtonHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsUseCkeditorPluginsUiButtonHtml.__proto__ || Object.getPrototypeOf(docsUseCkeditorPluginsUiButtonHtml)).apply(this, arguments));
    }

    return docsUseCkeditorPluginsUiButtonHtml;
  }(Component);

  Soy.register(docsUseCkeditorPluginsUiButtonHtml, templates);
  this['metalNamed']['ui_button'] = this['metalNamed']['ui_button'] || {};
  this['metalNamed']['ui_button']['docsUseCkeditorPluginsUiButtonHtml'] = docsUseCkeditorPluginsUiButtonHtml;
  this['metalNamed']['ui_button']['templates'] = templates;
  this['metal']['ui_button'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['ui_button'];
  ...
  this['metal']['docsUseCkeditorPluginsUiButtonHtml'] = docsUseCkeditorPluginsUiButtonHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param442 = function param442() {
        ...
        ie_open('a', null, null, 'alt', 'download spell checker as you type plugin', 'href', 'http://ckeditor.com/addon/scayt');
        itext('Scayt');
        ie_close('a');
        ...
        ie_close('h2');
        ie_open('p');
        itext('The plugin\xB4s code contains ');
        ie_open('a', null, null, 'alt', 'code of plugin', 'href', 'https://github.com/WebSpellChecker/ckeditor-plugin-scayt/blob/master/plugin.js#L39');
        ...
        ie_open('a', null, null, 'alt', 'Name of buttons', 'href', 'https://github.com/WebSpellChecker/ckeditor-plugin-scayt/blob/master/plugin.js#L39');
        itext('code');
        ie_close('a');
  ...
  var docsUseCkeditorPluginsUiMenuButtonBridgeHtml = function (_Component) {
    babelHelpers.inherits(docsUseCkeditorPluginsUiMenuButtonBridgeHtml, _Component);

    function docsUseCkeditorPluginsUiMenuButtonBridgeHtml() {
      babelHelpers.classCallCheck(this, docsUseCkeditorPluginsUiMenuButtonBridgeHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsUseCkeditorPluginsUiMenuButtonBridgeHtml.__proto__ || Object.getPrototypeOf(docsUseCkeditorPluginsUiMenuButtonBridgeHtml)).apply(this, arguments));
    }

    return docsUseCkeditorPluginsUiMenuButtonBridgeHtml;
  }(Component);

  Soy.register(docsUseCkeditorPluginsUiMenuButtonBridgeHtml, templates);
  this['metalNamed']['ui_menu_button_bridge'] = this['metalNamed']['ui_menu_button_bridge'] || {};
  this['metalNamed']['ui_menu_button_bridge']['docsUseCkeditorPluginsUiMenuButtonBridgeHtml'] = docsUseCkeditorPluginsUiMenuButtonBridgeHtml;
  this['metalNamed']['ui_menu_button_bridge']['templates'] = templates;
  this['metal']['ui_menu_button_bridge'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['ui_menu_button_bridge'];
  ...
  this['metal']['docsUseCkeditorPluginsUiMenuButtonBridgeHtml'] = docsUseCkeditorPluginsUiMenuButtonBridgeHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param466 = function param466() {
        ...
        ie_open('span', null, null, 'class', 'code-header');
        itext('You can download ');
        ie_open('a', null, null, 'alt', 'download color button plugin', 'href', 'http://ckeditor.com/addon/colorbutton');
        ...
        ie_open('p');
        itext('This button is given by \'undo\' CKEDITOR plugin. ');
        ie_open('a', null, null, 'alt', 'code source of color button plugin', 'href', 'https://github.com/ckeditor/ckeditor-dev/blob/3876e730d418107f791eef517178b0048a2c9383/plugins/colorbutton/plugin.js#L31');
        itext('It\xB4s code source');
        ie_close('a');
        itext(' contains this part of code: ');
        ie_close('p');
        ...
        ie_open('p');
        itext('Into the plugin appears this ');
        ie_open('a', null, null, 'alt', 'Name of buttons', 'href', 'https://github.com/ckeditor/ckeditor-dev/blob/master/plugins/colorbutton/plugin.js#L23,L42');
        itext('code');
        ie_close('a');
  ...
  var docsUseCkeditorPluginsUiPanelMenuButtonHtml = function (_Component) {
    babelHelpers.inherits(docsUseCkeditorPluginsUiPanelMenuButtonHtml, _Component);

    function docsUseCkeditorPluginsUiPanelMenuButtonHtml() {
      babelHelpers.classCallCheck(this, docsUseCkeditorPluginsUiPanelMenuButtonHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsUseCkeditorPluginsUiPanelMenuButtonHtml.__proto__ || Object.getPrototypeOf(docsUseCkeditorPluginsUiPanelMenuButtonHtml)).apply(this, arguments));
    }

    return docsUseCkeditorPluginsUiPanelMenuButtonHtml;
  }(Component);

  Soy.register(docsUseCkeditorPluginsUiPanelMenuButtonHtml, templates);
  this['metalNamed']['ui_panel_menu_button'] = this['metalNamed']['ui_panel_menu_button'] || {};
  this['metalNamed']['ui_panel_menu_button']['docsUseCkeditorPluginsUiPanelMenuButtonHtml'] = docsUseCkeditorPluginsUiPanelMenuButtonHtml;
  this['metalNamed']['ui_panel_menu_button']['templates'] = templates;
  this['metal']['ui_panel_menu_button'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['ui_panel_menu_button'];
  ...
  this['metal']['docsUseCkeditorPluginsUiPanelMenuButtonHtml'] = docsUseCkeditorPluginsUiPanelMenuButtonHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param495 = function param495() {
        ...
        ie_open('span', null, null, 'class', 'code-header');
        itext('You can download ');
        ie_open('a', null, null, 'alt', 'font plugin', 'href', 'http://ckeditor.com/addon/colorbutton');
        itext('font size and family plugin');
        ie_close('a');
        itext(' and, after that, you can paste it into ');
        ie_open('strong');
        ...
        ie_open('p');
        itext('The plugin\xB4s code contains ');
        ie_open('a', null, null, 'alt', 'code of plugin', 'href', 'https://github.com/ckeditor/ckeditor-dev/blob/master/plugins/font/plugin.js#L35');
        itext('this part of code');
        ie_close('a');
        itext('.');
        ie_close('p');
        ...
        ie_open('p');
        itext('Into the plugin appears this ');
        ie_open('a', null, null, 'alt', 'Name of buttons', 'href', 'https://github.com/ckeditor/ckeditor-dev/blob/master/plugins/font/plugin.js#L232-L233');
        itext('code');
        ie_close('a');
  ...
  var docsUseCkeditorPluginsUiRichComboHtml = function (_Component) {
    babelHelpers.inherits(docsUseCkeditorPluginsUiRichComboHtml, _Component);

    function docsUseCkeditorPluginsUiRichComboHtml() {
      babelHelpers.classCallCheck(this, docsUseCkeditorPluginsUiRichComboHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsUseCkeditorPluginsUiRichComboHtml.__proto__ || Object.getPrototypeOf(docsUseCkeditorPluginsUiRichComboHtml)).apply(this, arguments));
    }

    return docsUseCkeditorPluginsUiRichComboHtml;
  }(Component);

  Soy.register(docsUseCkeditorPluginsUiRichComboHtml, templates);
  this['metalNamed']['ui_rich_combo'] = this['metalNamed']['ui_rich_combo'] || {};
  this['metalNamed']['ui_rich_combo']['docsUseCkeditorPluginsUiRichComboHtml'] = docsUseCkeditorPluginsUiRichComboHtml;
  this['metalNamed']['ui_rich_combo']['templates'] = templates;
  this['metal']['ui_rich_combo'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['ui_rich_combo'];
  ...
  this['metal']['docsUseCkeditorPluginsUiRichComboHtml'] = docsUseCkeditorPluginsUiRichComboHtml;
}).call(this);
}).call(this);
